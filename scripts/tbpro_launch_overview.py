...
<section class="section" id="story">
  ...
  <div class="bento">
    ...
    <div class="tile tile--span3">
      ...
      <div class="tile__sub">{total_combined} contacts / {TOTAL_INVITEES:,} invitees · tickets + ideas + comments<br><span class="wave-note">Flights 4–5 (14k, Jun 29–Jul 6) recently sent — rate will rise as those tickets arrive</span></div>
    </div>
...
const P = {{
  ...
  waveW5:    root.getPropertyValue('--color-wave-w5').trim()   || '#a855f7',
}};
...
const milestones = [
  ...
  {{"date": "{WAVES[5]["date"]}", "label": "{WAVES[5]["label"]}", "color": P.waveW5}},
];
