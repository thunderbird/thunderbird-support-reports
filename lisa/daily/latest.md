...
_Updated: **2026-06-06 10:44 ET** · refreshes hourly_  
...
- **[#6092](https://tbpro.zendesk.com/agent/tickets/6092)** · アカウント作成が完了しません
  > はじめまして。サンダーバードメールに関心があり、アカウント作成を試みました。 しかし、アカウント作成が完了しないのでメール致しました。 Create an accountの画面でアカント作成を始めました。その後の作業は送信されるメール経由で行うとのことでしたが、そのメールがきません。…
